#!/usr/bin/env node
/**
 * Build SpoofDPI 1.2.1 (kelle-proxy) and copy to spoofdpi/ and src-tauri/binaries/.
 * Requires Go in PATH.
 */
...
const outExe = path.join(root, 'spoofdpi', 'kelle-proxy.exe');
...
console.log('Building SpoofDPI (kelle-proxy)...');
